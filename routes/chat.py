...
def chat():
        ...
        "tools": [
            {
                "toolSpec": {
                    "name": "generate_plan",
                    "description": "Generate the project plan matching the requested schema.",
                    "inputSchema": {
                        "json": {
                            "type": "object",
                            "properties": {
                                "reply": {"type": "string", "description": "The AI conversational response"},
                                "mvp": {
                                    "type": "array",
                                    "items": {
                                        "type": "object",
                                ...
                                "tag_bubble": {"type": "string"},
                                "gatekeeper_note": {"type": "string"}
                            },
                            "required": ["reply"]
                        }
                    }
    ...
    try:
        raw = call_bedrock(system_prompt, bedrock_messages, tool_config=tool_config)
